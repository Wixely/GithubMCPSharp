...
GithubMCPSharp is licensed under the MIT License (see `LICENSE`). It depends on
...
"GitHub" is a trademark of GitHub, Inc. Use of the name in this project does not
imply endorsement by, or affiliation with, GitHub.
