...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        try
        {
            ...
            Log.Information(
                "GithubMCPSharp starting on http://{Host}:{Port}{Path} (read-only={ReadOnly}, mode={Mode}, contentRoot={ContentRoot})",
                server.Host, server.Port, server.Path, github.IsReadOnly,
