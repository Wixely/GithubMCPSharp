...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.Console()
            .WriteTo.File(
                Path.Combine(contentRoot, "logs", "githubmcp-bootstrap-.log"),
        ...
        try
        {
            ...
            builder.Configuration
                ...
                .AddJsonFile(ResolveConfigFile(contentRoot, "GithubMCPSharp.json"), optional: true, reloadOnChange: true)
                .AddJsonFile(ResolveConfigFile(contentRoot, $"GithubMCPSharp.{builder.Environment.EnvironmentName}.json"), optional: true, reloadOnChange: true)
                .AddJsonFile(ResolveConfigFile(contentRoot, "GithubMCPSharp.Local.json"), optional: true, reloadOnChange: true)
                .AddEnvironmentVariables()
                .AddEnvironmentVariables(prefix: "GITHUBMCP_")
                .AddCommandLine(args);
            ...
            var github = app.Services.GetRequiredService<GithubService>();
            LogStartup(
                "GithubMCPSharp",
            ...
            {
                status = "ok",
                server = "GithubMCPSharp",
                path = server.Path,
                readOnly = github.IsReadOnly,
